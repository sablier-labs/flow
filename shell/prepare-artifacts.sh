...
cp out-optimized/SablierNFTDescriptor.sol/SablierNFTDescriptor.json $artifacts
...
cp out-optimized/ISablierNFTDescriptor.sol/ISablierNFTDescriptor.json $interfaces
