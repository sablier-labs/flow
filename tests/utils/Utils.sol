...
abstract contract Utils is CommonBase, Constants, PRBMathUtils {
    ...
    /// @dev Bounds the rate per second between a realistic range for USDC - [$77/month, $7700/month].;
    function boundRatePerSecond(UD21x18 ratePerSecond) internal pure returns (UD21x18) {
        return ud21x18(boundUint128(ratePerSecond.unwrap(), 0.00003e18, 0.003e18));
    }
